...
|Client ID|Client ID of the Microsoft Azure application. |True|hjkhj|
...
|Subscription ID|Subscription ID of the Microsoft Azure application.|True|hkhkj|
|Tenant ID|Tenant ID of the Microsoft Azure application.|True|kjhjk|
